...
import com.leif.common.constant.KEY_URL
import com.leif.common.manager.FileManager
...
import com.leif.main.databinding.ActivityImagePreviewBinding
import com.leif.main.utils.ImageUtil
...
class ImagePreviewActivity : BaseDataBindActivity<ActivityImagePreviewBinding>() {
    ...
    private fun saveImage() {
        lifecycleScope.launch {
            ...
            val res =
                if (success) com.leif.common.R.string.default_save_success else com.leif.common.R.string.default_save_fail
