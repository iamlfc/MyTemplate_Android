package com.leif.main.ui.login.login
...
import com.leif.common.constant.LOGIN_ACTIVITY_LOGIN
...
import com.leif.main.databinding.ActivityLoginBinding
import com.leif.main.ui.login.policy.PrivacyPolicyActivity
import com.leif.main.ui.login.register.RegisterActivity
    ...
    override fun initData() {
        mViewModel.loginLiveData.observe(this) { user ->
            ...
            user?.let {
                ...
                TipsToast.showTips(com.leif.common.R.string.success_login)
//                MainServiceProvider.toMain(context = this)
    ...
    private fun initListener() {
        ...
        mBinding.tvForgetPassword.onClick {
            TipsToast.showTips(com.leif.common.R.string.login_forget_password)
        }
...
//                .filter { it.isNotEmpty() }
    ...
    private fun toLogin() {
        ...
        if (password.isNullOrEmpty()) {
            TipsToast.showTips(com.leif.common.R.string.error_input_password)
            return
        }
    ...
    private fun setPasswordHide() {
        ...
        if (isShowPassword) {
            mBinding.ivPasswordToggle.setImageResource(com.leif.common.R.mipmap.ic_psw_invisible)
            mBinding.etPassword.transformationMethod = HideReturnsTransformationMethod.getInstance()
        } else {
            mBinding.etPassword.transformationMethod = PasswordTransformationMethod.getInstance()
            mBinding.ivPasswordToggle.setImageResource(com.leif.common.R.mipmap.ic_psw_visible)
        }
                ...
                object : ClickableSpan() {
                    override fun onClick(widget: View) {
                        (widget as TextView).highlightColor =
                            getColorFromResource(com.leif.common.R.color.transparent)
