...
import com.leif.common.model.CategoryItem
...
import com.leif.main.databinding.LayoutCategoryTabItemBinding
    ...
    override fun onBindDefViewHolder(
        ...
        holder.binding.apply {
            ...
            if (item.isSelected == true) {
                viewTag.visible()
                tvTitle.background = getBgDrawable(com.leif.common.R.color.white)
                ...
                when (position) {
                    ...
                    currPosition - 1 -> {
                        tvTitle.background =
                            getBgDrawable(color = com.leif.common.R.color.color_f0f2f4, rightBottomRadius = mRadius)
                    }
                    //后一个Item背景
                    currPosition + 1 -> {
                        tvTitle.background =
                            getBgDrawable(color = com.leif.common.R.color.color_f0f2f4, rightTopRadius = mRadius)
                    }
                    else -> {
                        tvTitle.background = getBgDrawable(color = com.leif.common.R.color.color_f0f2f4)
                    }
                }
                viewTag.gone()
