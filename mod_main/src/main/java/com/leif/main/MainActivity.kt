...
import com.leif.common.constant.KEY_INDEX
import com.leif.common.constant.MAIN_ACTIVITY_HOME
...
import com.leif.framework.utils.AppExit
import com.leif.framework.utils.StatusBarSettingHelper
import com.leif.main.databinding.ActivityMainBinding
import com.leif.main.navigator.SumFragmentNavigator
...
class MainActivity : BaseDataBindActivity<ActivityMainBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        setTheme(com.leif.common.R.style.AppTheme)
...
//        }
        AppExit.onBackPressed(
            this,
            { TipsToast.showTips(getString(com.leif.common.R.string.app_exit_one_more_press)) }
        )
    }
